package com.portobello.codegen;
...
public class DefaultGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("rust-domain") // use this codegen library
              .setInputSpec("/app/core/api-spec/openapi.yml")
              .setOutputDir("out/rust-domain"); // output directory
